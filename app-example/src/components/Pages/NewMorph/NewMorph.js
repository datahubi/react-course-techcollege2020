    ...
    <article {...morphs.container} className="open">
      ...
      <div className="open__inner">
        ...
        <p className="open__content">
          Reprehenderit distinctio voluptas deleniti dolorum ut temporibus natus
          facere inventore. Quia illum fugit laborum reprehenderit quis velit
          laboriosam magni nemo.
        </p>
      </div>
    </article>
  );
...
const Morph = () => {
  ...
  return (
    <section className="morph-container">
      <h1
        className={isOpen ? "morph-btn btn-open" : "morph-btn btn-closed"}
